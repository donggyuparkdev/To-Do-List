...
function filter(event) {
    ...
    document.getElementById("under-line").style.top = event.target.offsetTop + (event.target.offsetHeight - 4) + "px";
...
function randomIDGenerate() {
    ...
    // 랜덤 ID 생성 출처: https://gist.github.com/gordonbrander/2230317
}